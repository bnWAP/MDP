...
class WorkExperienceDialog : DialogFragment() {
    private lateinit var communicator: WorkExperienceDialogCallback
        ...
        val dialog = activity?.let {
            ...
            builder.setView(view).apply {
                ...
                view.findViewById<Button>(R.id.btn_add)?.setOnClickListener {
                    ...
                    communicator.onWorkExperienceAdded(WorkExperience(title, position, duration, R.drawable.ic_work_placeholder))
                    dismiss()
                }
    ...
    override fun onAttach(context: Context) {
        ...
        communicator = context as WorkExperienceDialogCallback
    }
}