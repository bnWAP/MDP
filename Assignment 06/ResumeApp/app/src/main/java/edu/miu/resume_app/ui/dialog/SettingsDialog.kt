...
import edu.miu.resume_app.utils.Utils

class SettingsDialog : DialogFragment() {
    private lateinit var communicator: ThemeCallback
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val dialog = activity?.let {
            ...
            val theme = AppUtils.getPref(getString(R.string.saved_theme), requireActivity())
    ...
    override fun onAttach(context: Context) {
        ...
        communicator = context as ThemeCallback
    }
}